...
const SCENES = [
  ...
  { id: 'scene_018', name: '电信诈骗/被骗钱', icon: 'icon-shield', color: '#F0F5FF', desc: '遭遇电信诈骗、被骗钱，立即拨打96110+110', keywords: ['诈骗', '被骗钱'], matchMode: 'any', channels: ['ch_030'], scripts: [], priority: 100 },
